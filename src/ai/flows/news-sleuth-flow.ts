...
const prompt = ai.definePrompt({
  ...
  Analyze the following news information for potential biases, low credibility content, and overall trustworthiness. Provide a detailed report including an overall credibility score (0-100), a list of potential biases identified, specific content flagged for low credibility, and the reasoning behind your assessment.
