            ...
            <ScrollArea className="h-full">
              <div className="space-y-6 p-1">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground/80 leading-relaxed whitespace-pre">{result.credibilityReport.summary}</p>
                </div>
                <Separator />
                <div>
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground/80 leading-relaxed whitespace-pre">{result.credibilityReport.reasoning}</p>
                </div>
                <Separator />
                <div>
